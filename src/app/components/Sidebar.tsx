...
import { IoBrowsersOutline, IoCalculator, IoHome } from 'react-icons/io5'
...
export const Sidebar = () => {
    return (
        <div id="menu"
        style={{ width: '400px' }}
        className="bg-black min-h-screen z-10 text-slate-300 w-64 left-0 h-screen overflow-y-scroll">
            <div id="logo" className="my-4 px-6">
                <h1 className="flex items-center text-lg md:text-2xl font-bold text-white">APP<span className="text-yellow-700">PRIVE</span></h1>
                <IoHome className='mr-2'></IoHome>
                <p className="text-slate-500 text-sm">Dashboard to mange activities</p>
            </div>
            ...
            <div id="nav" className="w-full px-6">
                ...
                <a href="#" className="w-full px-2 inline-flex space-x-2 items-center border-b border-slate-700 py-3 hover:bg-white/5 transition ease-linear duration-150">
                    ...
                    <div className="flex flex-col">
                        <span className="text-lg text-slate-300 font-bold leading-5">Partners</span>
                        <span className="text-sm text-slate-500 hidden md:block">Partners Manager</span>
                    </div>
                </a>
                <a href="#" className="w-full px-2 inline-flex space-x-2 items-center border-b border-slate-700 py-3 hover:bg-white/5 transition ease-linear duration-150">
                    <div>
                    ...
                    <div className="flex flex-col">
                        <span className="text-lg text-slate-300 font-bold leading-5">Influencers</span>
                        <span className="text-sm text-slate-500 hidden md:block">Manage Influencers</span>
                    </div>
                </a>
                <a href="#" className="w-full px-2 inline-flex space-x-2 items-center border-b border-slate-700 py-3 hover:bg-white/5 transition ease-linear duration-150">
                    <div>
